...
/**
 * Unit tests for {@link IdentityJwtAuthenticationFilter}.
 *
 ...
 *
 * @see IdentityJwtAuthenticationFilter
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("IdentityJwtAuthenticationFilter")
class IdentityJwtAuthenticationFilterTest {
    ...
    @InjectMocks
    private IdentityJwtAuthenticationFilter filter;
