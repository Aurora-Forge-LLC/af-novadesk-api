...
public class AssetAttachmentController implements AssetAttachmentApi {
    ...
    @Override
    public void download(UUID assetId, UUID attachmentId, HttpServletResponse response) throws IOException {
        attachmentService.downloadAttachment(assetId, attachmentId, response);
    }
